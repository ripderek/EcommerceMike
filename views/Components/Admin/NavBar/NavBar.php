...
<head>
    ...
    <link rel="stylesheet" href="<?php echo SERVERURL; ?>views/Components/Admin/NavBar/NavbarAdmin.css">

</head>

<body>
    <header class="header">
        <nav class="nav container w-auto">
            <div class="nav__data">
    ...
    <script src="<?php echo SERVERURL; ?>views/Components/Admin/NavBar/Js/main.js"></script>
</body>
